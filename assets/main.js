...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.icons-component.style-1', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 125, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-1', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-3', { style: 'fade-up', speed: 1125, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-4', { style: 'fade-up', speed: 1125, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-2', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('.text-component.instance-17', { style: 'fade-up', speed: 1125, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-16', { style: 'fade-up', speed: 1125, intensity: 3, threshold: 3, delay: 0, replay: false });
